<?php
	...
	function doDefault($msg = '') {
		...
		$columns = array(
			'server' => array(
				...
				'field' => field('desc'),
				'url'   => "/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/redirect.php?subject=server&amp;",
	...
	function doTree() {
		...
		/* group subtree */
			...
			include_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/classes/ArrayRecordSet.php');
