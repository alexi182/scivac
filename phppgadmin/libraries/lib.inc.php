<?php
	...
	include_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/libraries/decorator.inc.php');
	include_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/lang/translations.php');
	...
	if (file_exists('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/conf/config.inc.php')) {
		$conf = array();
		include('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/conf/config.inc.php');
	}
	else {
	...
	$lang = array();
	require_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/lang/english.php');

	// Create Misc class references
	require_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/classes/Misc.php');
	$misc = new Misc();
	...
	if (isset($_REQUEST['theme']) && is_file("/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/themes/{$_REQUEST['theme']}/global.css")) {
	...
	if (!isset($_theme) && isset($_SESSION['ppaTheme']) && is_file("/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/themes/{$_SESSION['ppaTheme']}/global.css")) {
		$conf['theme']  = $_SESSION['ppaTheme'];
	}

	// 3. Check for theme in cookie var
	if (!isset($_theme) && isset($_COOKIE['ppaTheme']) && is_file("/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/themes/{$_COOKIE['ppaTheme']}/global.css")) {
	...
	if (isset($_language)) {
		include("/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/lang/{$_language}.php");
	...
	// Manage the plugins
	require_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/classes/PluginManager.php');
	...
	if (!isset($_no_db_connection)) {
		...
		if (!isset($_server_info['username'])) {
			include('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/login.php');
			exit;
		}
		...
		include_once('/srv/www/scivac.pr.informika.ru/releases/20170426072046/web/phppgadmin/classes/database/Connection.php');
